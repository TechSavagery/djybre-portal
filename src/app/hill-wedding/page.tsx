...
function EpisodeEntry({ episode }: { episode: Episode }) {
  ...
  return (
    <article
      ...
      className="rounded-lg py-10 sm:py-12"
    >
      <Container>
...
export default async function Home() {
  ...
  return (
    <div className="rounded-lg pb-12 pt-16 sm:pb-4 lg:pt-12">
      <Container>
        <h1 className="text-2xl font-bold leading-7 text-slate-900">
          Requests
        </h1>
      </Container>
      <div className="rounded-lg divide-y divide-slate-100 sm:mt-4 lg:mt-8 lg:border-t lg:border-slate-100">
